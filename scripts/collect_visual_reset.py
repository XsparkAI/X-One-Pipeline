...
class RestWorker(QtCore.QThread):
...
class DataCollectorUI(QtWidgets.QWidget):
    ...
    def update_stats(self):
        ...
        task_name = self.robot.collector.collect_cfg.get("task_name", "None")
        ...
        if self.worker_name and task_name != "None":
            ...
            dataset_path = os.path.join(save_dir, task_name)
    ...
    def stop_capture(self):
        ...
        self.stop_worker = RestWorker(self.robot, is_save=True)
...
class MockRobot:
    ...
    def collect(self, data):
        pass
    def _change_mode(self, teleop=True):
        pass
...
if __name__ == '__main__':
    ...
    if TEST_MODE:
        ...
        base_cfg = load_yaml("./config/x-one.yml")
