...
if __name__ == "__main__":
    ...
    robot.replay(data_path=os.path.join(save_dir, f"{args_cli.idx}.hdf5"), fps= base_cfg["collect"].get("save_freq", 30), key_banned=["eef"], is_collect=args_cli.collect, episode_id=args_cli.collect_idx)