...
class Dual_X_Arm(Robot):
    ...
    def set_up(self, teleop=False):
        ...
        self.controllers["arm"]["left_arm"].set_up(self.robot_config['robot']['ROBOT_CAN']['left_arm'], teleop=teleop)
        self.controllers["arm"]["right_arm"].set_up(self.robot_config['robot']['ROBOT_CAN']['right_arm'], teleop=teleop)

        self.sensors["image"]["cam_head"].set_up(self.robot_config['robot']['CAMERA_SERIALS']['head'], is_depth=False, is_jpeg=True)
        self.sensors["image"]["cam_left_wrist"].set_up(self.robot_config['robot']['CAMERA_SERIALS']['left_wrist'], is_depth=False, is_jpeg=True)
        self.sensors["image"]["cam_right_wrist"].set_up(self.robot_config['robot']['CAMERA_SERIALS']['right_wrist'], is_depth=False, is_jpeg=True)
